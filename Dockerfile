...
##   $ docker build -t java-for-n1kt0-stacksmith_playground .
##
## RUNNING
##   $ docker run java-for-n1kt0-stacksmith_playground

FROM gcr.io/stacksmith-images/minideb-buildpack:jessie-r8

MAINTAINER Bitnami <containers@bitnami.com>

ENV STACKSMITH_STACK_ID="e8iigew" \
    STACKSMITH_STACK_NAME="Java for n1kt0/stacksmith_playground" \
